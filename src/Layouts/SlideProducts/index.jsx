...
class SlideProducts extends React.Component{
    ...
    render(){
        ...
        return(
            <div className="over">
                <img src="https://stagingimg.gkitchen.com.vn/products/productImages-1558409288736.png" className="img-products"></img>
                <div className="content">
                    <div className="content-title">SẢN PHẨM NGON TUẦN NÀY</div>
                    <div className="content-sub">Sườn già 300g</div>
                    <img src="https://gkitchen.com/images/home/line.png" />
